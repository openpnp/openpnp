...
A new version of the manual with a focus on how to do things rather than a reference of what things are. More in the theme of the Setup and Calibration Guide.

Note to self: Use toc generator.

# Welcome
# Installation
just link to quick start
# --User Interface--
this stuff is covered in the quick start, I don't think we need to go into it further here, stick to tasks

think of what needs to be done to go from a machine that can move around to actually running a job and break those out
* Create a job
* Add a board
* Import board data
* Setup packages
...
# Appendices
maybe some reference stuff could go in the appendix
* coordinate system
* ui overview
* hotkeys
* understanding Z
