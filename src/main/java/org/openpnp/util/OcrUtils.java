...
public class OcrUtils {
    public static final String BARCODE_PSEUDO_FONT = "[Barcode]";
    ...
    public static List<String> createFontSelectionList(String selectedFont, boolean addEmpty) {
        ...
        systemFontList.add(BARCODE_PSEUDO_FONT);
        systemFontList.addAll(Arrays.asList(GraphicsEnvironment.getLocalGraphicsEnvironment()
