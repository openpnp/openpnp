...
public class CameraCalibrationUtils {
    ...
    public static double[] ComputeBestCameraParameters(double[][][] testPattern3dPoints, 
        ...
        CalibrationModel model = new CalibrationModel(testPattern3dPoints, flags);
        ...
        RealVector start = new ArrayRealVector(starting); //this needs to be populated with reasonable starting values
...
//        Logger.trace("parameter sigmas = " + optimum.getSigma(1e-12).toString());
    ...
    private static class CalibrationModel implements MultivariateJacobianFunction {
        ...
        public Pair<RealVector, RealMatrix> value(RealVector point) {
            ...
            return new Pair(funcValue, funcJacobian);
        }
