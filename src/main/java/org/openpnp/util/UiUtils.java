...
public class UiUtils {
    ...
    /**
     * Queue to collect and handle multiple and interrupted continuations generated by ExceptionWithContinuation
     */
    // FIXME: is Deque good for a LiFo queue?
    // FIXME: will this declaration create a single global queue?
    // FIXME: is showError() and this queue atomic enough to be safely interrupted while executing queued continuations?
    static private Deque<Thrunnable> continuationsQueue;
    ...
    public static void showError(Component parent, String title, Throwable t) {
        ...
        // Go through all causes, creating a list of continuations
        Deque<Thrunnable> continuations = new ArrayDeque<Thrunnable>();
        ...
        if (parent != null) {
            ...
            if (haveContinuations && execContinuations) {
                ...
                // add all continuations to the queue of continuations
                // this has to be done in the correct order:
                // - items in the list have to be executed in reverse order they are stored - to preserve their order of creation
                // - items in the list have to be executed before other items in the queue. - to give new exception precedence.
                // continuations is transfered in FiFo style to the queue in LiFo style.
                while (!continuations.isEmpty()) {
                    continuationsQueue.addFirst(continuations.removeFirst());
                }
