...
package org.openpnp.gui.importer.altium;
...
public class AltiumCsvImporter extends CsvImporter implements BoardImporter {
    ...
    public Board importBoard(Frame parent) throws Exception {
    	...
    	Board board = super.importBoard(parent, this);
	...
	public GenericCSVParser getParser() {
		return new AltiumCSVParser();
	}

	private class AltiumCSVParser extends GenericCSVParser {
