...
public class GcodeDriver extends AbstractSerialPortDriver implements Named, Runnable {
    ...
    public void home(ReferenceHead head) throws Exception {
        ...
        Axis xAxis = null;
        Axis yAxis = null;
        double xHomeCoordinateSquare = 0;
        double xHomeCoordinateNonSquare = 0;
        double yHomeCoordinate = 0;
        for (Axis axis : axes) {
            if (axis.getType() == Axis.Type.X) {
                xAxis = axis;
                xHomeCoordinateSquare = axis.getHomeCoordinate();
                xHomeCoordinateNonSquare = xHomeCoordinate;
            }
        ...
        // transformation). 
        // In order to home the square internal coordinate system we need to handle the 
        // non-squareness X offset (inversed). 
        // NOTE this changes nothing in the behaviour or coordinate system of the machine. It just
        ...
        xHomeCoordinateSquare -= nonSquarenessFactor*yHomeCoordinate;
