...
public class ReferenceNozzle extends AbstractNozzle implements ReferenceHeadMountable {
    ...
    public void pick(Part part) throws Exception {
        ...
        this.part = part;
        double pickVacuumThreshold = part.getPackage().getPickVacuumThreshold();
    ...
    public void place() throws Exception {
        ...
        double placeBlowThreshold = part.getPackage().getPlaceBlowThreshold();
        if (Double.compare(placeBlowThreshold, Double.valueOf(0.0)) != 0) {
            actuateBlowValve(placeBlowThreshold);
        } else {
