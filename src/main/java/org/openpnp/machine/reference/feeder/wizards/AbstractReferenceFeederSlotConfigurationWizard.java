 ...
 */
public abstract class AbstractReferenceFeederSlotConfigurationWizard
     ...
     */
    public AbstractReferenceFeederSlotConfigurationWizard(ReferenceFeederSlot feederSlot) {
        ...
        JLabel lblPart = new JLabel("Currently mounted feeder");
...
/*        addWrappedBinding(feederSlot, "part", comboBoxPart, "selectedItem");
        addWrappedBinding(feederSlot, "retryCount", retryCountTf, "text", intConverter);
