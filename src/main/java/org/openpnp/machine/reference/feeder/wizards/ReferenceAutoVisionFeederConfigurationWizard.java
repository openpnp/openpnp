...
public class ReferenceAutoVisionFeederConfigurationWizard
extends AbstractReferenceFeederConfigurationWizard {
    private final ReferenceAutoVisionFeeder feeder;

    public ReferenceAutoVisionFeederConfigurationWizard(ReferenceAutoVisionFeeder feeder) {
        super(feeder, false);
        this.feeder = feeder;
...
// Panel: Vision
        ...
        comboBoxCalibrationTrigger = new JComboBox(ReferenceAutoVisionFeeder.CalibrationTrigger.values());
