...
import org.openpnp.machine.reference.feeder.ZevatechFeeder;
import org.openpnp.machine.reference.feeder.ZevatechFeeder.ActuatorType;
...
public class ReferenceZevatechFeederConfigurationWizard
        extends AbstractReferenceFeederConfigurationWizard {
    private final ZevatechFeeder feeder;
    ...
    public ReferenceZevatechFeederConfigurationWizard(ZevatechFeeder feeder) {
        super(feeder);
        this.feeder = feeder;
