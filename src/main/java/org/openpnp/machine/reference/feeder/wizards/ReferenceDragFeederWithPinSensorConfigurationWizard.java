...
public class ReferenceDragFeederWithPinSensorConfigurationWizard extends AbstractReferenceFeederConfigurationWizard {
...
public ReferenceDragFeederWithPinSensorConfigurationWizard(ReferenceDragFeeder feeder) {
super(feeder);
this.feeder = feeder;
	...
	private Action confirmSelectTemplateImageAction = new AbstractAction("Confirm") {
		...
		public void actionPerformed(ActionEvent arg0) {
			UiUtils.messageBoxOnException(() -> {
				...
				if (image == null) {
					MessageBoxes.errorBox(ReferenceDragFeederWithPinSensorConfigurationWizard.this, "No Image Selected",
