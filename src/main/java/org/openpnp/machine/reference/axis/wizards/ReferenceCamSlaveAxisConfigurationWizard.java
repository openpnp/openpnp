...
public class ReferenceCamSlaveAxisConfigurationWizard extends AbstractAxisConfigurationWizard {
    ...
    public ReferenceCamSlaveAxisConfigurationWizard(AbstractMachine machine, ReferenceCamSlaveAxis axis) {
        super(axis);
        panelTransformation = new JPanel();
        panelTransformation.setBorder(new TitledBorder(null, "Cam Axis (Slave)", TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        lblInputAxis = new JLabel("Master Axis");
        panelTransformation.add(lblInputAxis, "2, 2, right, default");

        inputAxisModel = new AxesComboBoxModel(machine, ReferenceCamMasterAxis.class, null, true);
