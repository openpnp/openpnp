...
import org.openpnp.machine.reference.DemoPnpJobProcessor.JobPlacement.Status;
...
@Root
public class DemoPnpJobProcessor extends AbstractPnpJobProcessor {
    enum State {
        Uninitialized,
        PreFlight,
        FiducialCheck,
    ...
    private static final Logger logger = LoggerFactory.getLogger(DemoPnpJobProcessor.class);
