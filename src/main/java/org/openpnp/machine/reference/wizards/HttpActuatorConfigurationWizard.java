...
public class HttpActuatorConfigurationWizard extends AbstractActuatorConfigurationWizard {
    ...
    protected void createUi(AbstractMachine machine) {
        ...
        panelProperties.setBorder(new TitledBorder(null, Translations.getString("CommonWords.Properties"), TitledBorder.LEADING, //$NON-NLS-1$
        ...
        lblName = new JLabel(Translations.getString("CommonWords.Name")); //$NON-NLS-1$
        ...
        lblOnUrl = new JLabel(Translations.getString("HttpActuatorConfigurationWizard.OnUrl")); //$NON-NLS-1$
        ...
        lblOffUrl = new JLabel(Translations.getString("HttpActuatorConfigurationWizard.OffUrl")); //$NON-NLS-1$
        ...
        lblParametricUrl = new JLabel(Translations.getString("HttpActuatorConfigurationWizard.ParametricUrl")); //$NON-NLS-1$
        lblParametricUrl.setToolTipText(Translations.getString("HttpActuatorConfigurationWizard.ParametricUrl.Tooltip")); //$NON-NLS-1$
        ...
        lblReadUrl = new JLabel(Translations.getString("HttpActuatorConfigurationWizard.ReadUrl")); //$NON-NLS-1$
        ...
        lblRegex = new JLabel(Translations.getString("HttpActuatorConfigurationWizard.RegularExpression")); //$NON-NLS-1$
