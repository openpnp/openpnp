...
/**
 * Save the working image as an image file in the debug directory using the specified prefix
 * and suffix. The suffix should be a file extension (including the period).
 */
