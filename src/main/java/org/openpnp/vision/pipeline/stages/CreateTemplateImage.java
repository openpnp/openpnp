...
public class CreateTemplateImage extends CvStage {
    ...
    @Attribute(required = false)
    @Property(description = "Orientation of the output image. Zero is up, angles increase clockwise.")
    ...
    public Result process(CvPipeline pipeline) throws Exception {
      ...
      Mat image = pipeline.getWorkingImage().clone();
      ...
      /*
        warpAffine can also crop the image, after rotating it, to bbox.size(), 
        so there is no need for a following crop stage
      */
