...
public interface Actuator
    ...
    /**
     * Will return the actuator value type
     */
    public Class<?> getValueClass();

    /**
     * Will return the allowed values
     */
    public Object[] getValues();

    /**
     * Provides the actuator with a generic value to which it can respond in an implementation
     * dependent manner. This will ultimately call typed actuate() methods according to getValueClass()().
     *
     * @param value
     * @throws Exception
     */
