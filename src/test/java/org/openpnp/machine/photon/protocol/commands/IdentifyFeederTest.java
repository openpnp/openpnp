...
public class IdentifyFeederTest {
    ...
    public void createCommand() {
        Packet identifyFeederPacket = new IdentifyFeeder(uuid_s).toPacket();
        assertEquals(0xff, identifyFeederPacket.toAddress);
        assertEquals(13, identifyFeederPacket.payloadLength);
        assertArrayEquals(new int[]{
                0xC1,
                uuid_b[0], uuid_b[1], uuid_b[2], uuid_b[3],
                uuid_b[4], uuid_b[5], uuid_b[6], uuid_b[7],
                uuid_b[8], uuid_b[9], uuid_b[10], uuid_b[11],
        }, identifyFeederPacket.payload);
    }
    ...
    public void decodeOk() {
        ...
        IdentifyFeeder.Response response = new IdentifyFeeder.Response(responsePacket);
