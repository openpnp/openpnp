...
10. Download the new firmware<br>
CHM-T36VA: [main.hex](https://github.com/ElectronicsSam/Smoothieware-CHMT)<br>
CHM-T48VB: [main.hex](https://github.com/c-riegel/Smoothieware-CHMT)<br>
Follow the link. Click the green "Clone or download" button.  Click "Download ZIP".  Inside the "STM32F407xG" folder you will find the main.hex file that you will flash on to the control board.
