...
public class EagleMountsmdUlpImporter extends JDialog implements BoardImporter {
	...
	public EagleMountsmdUlpImporter(Frame parent) {
	...
	private class SwingAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			FileDialog fileDialog = new FileDialog(EagleMountsmdUlpImporter.this);
	...
	private class SwingAction_2 extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				MessageBoxes.errorBox(EagleMountsmdUlpImporter.this, "Import Error", e1);
				return;
			}
