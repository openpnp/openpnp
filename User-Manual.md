...
- **Feeder**: A feeder can be both a piece of hardware that can supply parts, and a featyre in OpenPnP that allows it to pick parts from non-hardware sources. OpenPnP supports feeding from automatic feeders, cut tape strips, "drag" style feeders, tubes, trays, and bins of loose parts.
