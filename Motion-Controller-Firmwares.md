...
-XYZ Limit switches
-x2 Analog inputs for neg/positive nozzle pressure
-x1 binary input for drap pin state detection
...
`G4 S2	; wait for CAN expansion boards to start`

`;***Axis/Drives`
`;-M569: Set motor driver direction, enable polarity, mode and step pulse timing \ https://duet3d.dozuki.com/Wiki/M569`
`;XY driven by off board CAN expansion for encoding and 48V, beginning CAN ID 40`
